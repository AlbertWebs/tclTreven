            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <center> <h2> Add Project & Gallery </h2> </center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
               ...
               <center>
				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Label</label>

                        <div class="col-lg-8">
                            <input readonly type="text" id="text1" name="client" value="" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <select name="cat" data-placeholder="Choose Service rendered" class="form-control chzn-select" tabindex="2">
                           ...
                           <?php $TheCategoryList = DB::table('services')->get(); ?>

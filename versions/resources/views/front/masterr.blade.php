        ...
        <!-- <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 d-none d-lg-block">
                    <div class="mainmenu" id="navbarSupportedContent">
                        <ul id="navigation">
            	...
            	<nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                            @foreach($Sitesettings as $Settings)
                            <div class="logo">
                            <a class="navbar-brand logo_h" href="{{url('/')}}"><img src="{{url('/')}}/uploads/logo/{{$Settings->logo}}" alt=""></a>
                            </div>
                            @endforeach
                        </div>
						...
						<!-- Collect the nav links, forms, and other content for toggling -->
                            ...
                            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                                <ul class="nav navbar-nav menu_nav ml-auto">
                                    <li class="nav-item active"><a class="nav-link" href="{{url('/')}}"><i class="fa fa-home"></i> Home</a></li>
                                    <!-- <li class="nav-item"><a class="nav-link" href="{{url('/about')}}">About</a></li> -->
                                    <!-- <li class="nav-item"><a class="nav-link" href="{{url('/services')}}">Services</a></li> -->
                                    <!-- <li class="nav-item"><a class="nav-link" href="{{url('/portfolio')}}"> Portfolio</a></li> -->
                                    <!-- <li class="nav-item"><a class="nav-link" href="{{url('/contact')}}"><i class="fa fa-phone"></i> Contact</a></li> -->
                                </ul>
                            </div> 
                      </div> <!--EndRow-->
                   </div> <!--EndContainer-->

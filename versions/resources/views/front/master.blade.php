					...
					<div class="copyriight_block ptb-20 mt-20">
						<div class="row">
							...
							<div class="col-sm-8 text-right">
								<p>
									&copy; <?php $date = date('Y'); echo $date; ?> <a href="{{url('/copyright')}}">{{$Settings->sitename}}</a> All Rights Reserved | Powered By <a href="https://designekta.com">Designekta Studios</a> 
								</p>
							</div>
						</div>
					</div>

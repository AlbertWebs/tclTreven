				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input readonly type="text" id="text1" name="client" value="{{$Portfolio->client}}"  class="form-control" />
                        </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select name="cat" data-placeholder="Choose Service rendered" class="form-control chzn-select" tabindex="2">
                           <option value="{{$Portfolio->cat}}">
                           <?php $Cat = DB::table('services')->where('id',$Portfolio->cat)->get(); ?>
                                                    @foreach($Cat as $cat){{$cat->title}} @endforeach
                           </option>
                    ...
                    <input type="hidden" name="image_ten_cheat" value="{{$Portfolio->image_ten}}">
                    <input type="hidden" name="image_eleven_cheat" value="{{$Portfolio->image_eleven}}">
                    <input type="hidden" name="image_twelve_cheat" value="{{$Portfolio->image_twelve}}">

...
class HomeController extends Controller
{
    ...
    { 
        ...
        SEOMeta::setDescription('Treven Cleaners is The Best Cleaning Company in Nairobi');
        ...
        Twitter::setSite('@trevencleaners');
    ...
    public function portfolio()
    {
        ...
        SEOMeta::setDescription('Treven Cleaners Best Cleaning Company in Machakos');
        SEOMeta::setCanonical('http://trevencleanersltd.co.ke/our-work');

        OpenGraph::setDescription('Treven Cleaners Best Cleaning Company in Machakos');
    ...
    public function contact()
    {
        ...
        foreach($SiteSettings as $set){
            ...
            SEOMeta::setDescription('Contact Treven Cleaners On: Mobile: '.$set->mobile.' Email Us : '.$set->email.' ');
    ...
    public function about()
    {
        ...
        SEOMeta::setDescription('Treven Cleaners is The Best Cleaning Company in Kiambu');
        SEOMeta::setCanonical('http://trevencleanersltd.co.ke/about-us');
    ...
    public function terms()
    {
        ...
        SEOMeta::setDescription('Treven Cleaners Limited');
        SEOMeta::setCanonical('http://trevencleanersltd.co.ke/terms-and-conditions');
    ...
    public function privacy()
    {
        ...
        SEOMeta::setDescription('Treven Cleaners Limited');
        SEOMeta::setCanonical('http://trevencleanersltd.co.ke/privacy-policy');
    ...
    public function copyright()
    {
        ...
        SEOMeta::setDescription('Trevens Cleaners Limited');
    ...
    {
        SEOMeta::setTitle('Our Services | Treven Cleaners Limited - Best Cleaning Company in Nairobi , Best Cleaning Company in Machakos, Best Cleaning Company in Kiambu');
        SEOMeta::setDescription('Sofa Set Cleaning Services,Carpet Cleaning Services,Office Cleaning Services,Event and Party Cleaning,Vehicle Interior Cleaning,');
        SEOMeta::setCanonical('http://trevencleanersltd.co.ke/our-services');
    ...
    public function service($name)
    {
        ...
        SEOMeta::setCanonical('http://trevencleanersltd.co.ke/our-services/'.$name.'');
    ...
    public function requestQuote(){
        ...
        SEOMeta::setDescription('Treven Cleaners Request Quote');
        SEOMeta::setCanonical('http://trevencleanersltd.co.ke/request-quote');

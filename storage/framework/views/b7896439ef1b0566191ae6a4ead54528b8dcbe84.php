              ...
              <div class="row">
               <center>
				...
				<?php endif; ?>
                 ...
                 <form class="form-horizontal" method="post"  action="<?php echo e(url('/admin/edit_Portfolio')); ?>/<?php echo e($Portfolio->id); ?>" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input readonly type="text" id="text1" name="client" value="<?php echo e($Portfolio->client); ?>"  class="form-control" />
                        </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select name="cat" data-placeholder="Choose Service rendered" class="form-control chzn-select" tabindex="2">
                           <option value="<?php echo e($Portfolio->cat); ?>">
                           <?php $Cat = DB::table('services')->where('id',$Portfolio->cat)->get(); ?>
                                                    <?php $__currentLoopData = $Cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($cat->title); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </option>
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="content" id="wysihtml5" class="form-control" rows="10"><?php echo e($Portfolio->content); ?></textarea>
                    ...
                    <div class="form-group col-lg-4">
                     ...
                     <div class="form-group col-lg-4">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($Portfolio->image_six); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($Portfolio->image_seven); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($Portfolio->image_eight); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($Portfolio->image_nine); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($Portfolio->image_ten); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($Portfolio->image_eleven); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($Portfolio->image_twelve); ?>" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <input type="hidden" name="image_six_cheat" value="<?php echo e($Portfolio->image_six); ?>">
                    <input type="hidden" name="image_seven_cheat" value="<?php echo e($Portfolio->image_seven); ?>">
                    <input type="hidden" name="image_eight_cheat" value="<?php echo e($Portfolio->image_eight); ?>">
                    <input type="hidden" name="image_nine_cheat" value="<?php echo e($Portfolio->image_nine); ?>">
                    <input type="hidden" name="image_ten_cheat" value="<?php echo e($Portfolio->image_ten); ?>">
                    <input type="hidden" name="image_eleven_cheat" value="<?php echo e($Portfolio->image_eleven); ?>">
                    <input type="hidden" name="image_twelve_cheat" value="<?php echo e($Portfolio->image_twelve); ?>">

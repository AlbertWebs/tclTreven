<div id="right">
            ...
            <div class="well well-small">
                ...
                <button type="button" onclick="window.open('<?php echo e(url('/admin/values')); ?>','_self')" class="btn btn-primary btn-block"> Values</button>
                <button type="button" onclick="window.open('<?php echo e(url('/admin/products')); ?>','_self')" class="btn btn-primary btn-block"> Products</button>
                <button type="button" onclick="window.open('<?php echo e(url('/admin/files')); ?>','_self')" class="btn btn-primary btn-block"> Busines Profile</button>
